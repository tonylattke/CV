...
\usepackage[letterpaper,margin=0.75in,bottom=10mm,top=14mm]{geometry}
...
\item
  \headerrow
  {\textbf{Instalaciones RS 14 ca}}
  {\textbf{Caracas, Ve}}
  \\

  \headerrow
  {\emph{Autocad Drawer}}
  {\emph{09/2005 -- 02/2014}}
  \begin{itemize*}
  \item Drawing mechanical installations and pieces in Autocad.
  \end{itemize*}
...
\item 
 ...
 \item 
   ...
   {\textbf{Dtto. Capital, Ve}}
	\\
	\headerrow
   {\emph{High school student of science}}
...
\item[Languages:]
  Spanish (Native language), English (C1), German (B1)
...
\item
  Assume responsibilities and work with a team
\item
  Easy to work with a public
\item
