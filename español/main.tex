...
\item
  ...
  \headerrow
  {\emph{Dibujante en Autocad}}
  {\emph{09/2005 -- 02/2014}}
  \begin{itemize*}
  \item Dibujo de instalaciones y piezas mecánicas en Autocad.
  \end{itemize*}
...
\item
  ...
  \headerrow
  {\emph{Desarrollador Web}}
  {\emph{08/2013 -- 11/2013}}
  \begin{itemize*}
  \item Desarrollo de una aplicación web con python Django, CSS, HTML5 y Javascript.
  \item Uso de la herramienta de Twython de Twitter.
  \end{itemize*}
...
\item
  ...
  \headerrow
  {\emph{\href{http://clei2013.org.ve}{CLEI 2013} - Colaborador}}
  {\emph{10/2013 -- 10/2013}}
  \begin{itemize*}
  \item Colaborador miembro del comité de logística.
  \end{itemize*}

  \headerrow
  {\emph{\href{http://joincic.com.ve}{Jornadas Interuniversitarias de Ciencias de la Computación} - Coordinador General}}
  ...
  \headerrow
  {\emph{\href{http://usbceic.ldc.usb.ve}{Centro de Estudiantes de Ingeniería de la Computación} - Presidente}}
